...
// Copyright (c) 2014 HeisenbergHex Developers
...
uint256 hashGenesisBlock("0x88c29c3ee5266945249535a46ba9f2dc49f7132e4e9d6a17a1ec796b0289387d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // HeisenbergHex: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "HeisenbergHex Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    int64 nSubsidy = 0;     
        ...
        int rand = generateMTRandom(seed, 28800);
         ...
         if (nHeight == 1) {
            return 115000000 * COIN;
        } else if (nHeight == 2) {
            return 115000000 * COIN;

        } else if(nHeight > 2 && nHeight < 2881) {

                if(rand > 1 && rand < 14400) {  // 50%
                    nSubsidy = 1028000 * COIN;
                } else {
                   nSubsidy = 512000 * COIN;
                }
            
            //day 2
        } else if(nHeight > 2881 && nHeight < 5671) {

               if(rand > 14253 && rand < 21453) {  // 25%
                    nSubsidy = 1028000 * COIN;
                } else {
                   nSubsidy = 512000 * COIN;
                }   
            ...
            //next 16
        } else  if(nHeight > 46081 && nHeight < 92161) {
            ...
            //next 32
        } else  if(nHeight > 92161 && nHeight < 184321) {
            ...
            //next 64
        } else  if(nHeight > 184321 && nHeight < 368641) {
            ...
            //next 128
        } else  if(nHeight > 368641 && nHeight < 737281) {
            ...
            //next 256
        } else  if(nHeight > 737281 && nHeight < 1474561) {
            ...
            //next 512
        } else  if(nHeight > 1474561 && nHeight < 2949121) {

               if(rand > 666 && rand < 668) {// 0.00487%
                    nSubsidy = 1028000 * COIN;
                } else {
                   nSubsidy = 1000 * COIN;
                }
...
static const int64 nTargetTimespan = 30 * 30;                       // HeisenbergHex: every 15 minutes
static const int64 nTargetSpacing = 30;                             // HeisenbergHex: 30 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal HeisenbergHex miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HeisenbergHex", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 6, 2014 9PM EST";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x0a2a4c6dc58c8a6ac6f08ac70df20a93e296a4ba08d02bcbf7e0dea3501901af"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // HeisenbergHexd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
